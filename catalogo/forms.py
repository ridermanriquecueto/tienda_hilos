...
class ProductoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['nombre', 'precio', 'stock','descripcion', 'imagen', 'destacado', 'oferta']
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'destacado' in self.fields:
            self.fields['destacado'].widget.attrs.update({'class': 'form-check-input'})
        if 'oferta' in self.fields:
            self.fields['oferta'].widget.attrs.update({'class': 'form-check-input'})
...
class CheckoutForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['metodo_pago'].widget.attrs.update({'id': 'metodo_pago'})

        self.fields['metodo_envio'].widget.attrs.update({'id': 'metodo_envio'})
